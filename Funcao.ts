...
console.log(`Resultado: ${somar(17, 8)}`);
...
console.log(`Resultado: ${subtrair(223, 222)}`);
...
console.log(`Resultado: ${multiplicar(18, 10)}`);
...
console.log(`Resultado: ${dividir(22, 2)}`);
...
console.log(`Dobro de 12 = ${dobro(66)}`);
...
console.log(`Média = ${media(6, 6, 6).toFixed(2)}`);
